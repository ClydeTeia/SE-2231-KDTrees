...
const points = [
  ...
  new Point2D(0.621, 0.312),
  new Point2D(0.732, 0.654),
  new Point2D(0.289, 0.421),
  new Point2D(0.175, 0.633),
  new Point2D(0.438, 0.185)
];
...
let sketch = function (p) {
  ...
  p.draw = function () {
    ...
    p.stroke("black");
    // brute.draw(p);  // If you dont comment this it will hide the borders
